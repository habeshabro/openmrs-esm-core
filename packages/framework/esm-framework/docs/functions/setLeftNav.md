...
Defined in: [packages/framework/esm-extensions/src/left-nav.ts:37](https://github.com/habeshabro/openmrs-esm-core/blob/main/packages/framework/esm-extensions/src/left-nav.ts#L37)
