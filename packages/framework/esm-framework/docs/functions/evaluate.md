...
Defined in: [packages/framework/esm-expression-evaluator/src/evaluator.ts:97](https://github.com/habeshabro/openmrs-esm-core/blob/main/packages/framework/esm-expression-evaluator/src/evaluator.ts#L97)
