...
Defined in: [packages/framework/esm-offline/src/sync.ts:320](https://github.com/habeshabro/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/sync.ts#L320)
